#!/usr/bin/env python
# coding: utf-8
# train: python DeepEdit_v1.py --mode=train --train_csv=train.csv --test_csv=test.csv --output_fold=train --model_name=first_train
# predict: python DeepEdit_v1.py --mode=predict --predict_csv=predict.csv --output_fold=predict_result --model_name=model.h5
...
def predict(predict_csv,output_fold,model_name):
    ...
    data=data.iloc[:,:3]
    data[-1] = y_pred
    data.to_csv(output_fold+'/DeepEdit_result.txt',index=False,encoding='utf_8_sig')
